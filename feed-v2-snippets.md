...
- [Create a temporary XML feed](https://explain.helloretail.com/Wnu8gqjk){:target="_blank"}
- [Rewrite the request url to fetch extra data, and add authorization header](https://explain.helloretail.com/v1u9pLXJ){:target="_blank"}
- [Rewrite the selector path and remove all filter options](https://explain.helloretail.com/Qwuom4Oj){:target="_blank"}
